...
1. **Kick off P0 (platform foundation refactor).** Author the impl-plan with `/plan-feature`
   (`planning` skill), gate the module-package boundary design with `council-review` (architecture)
