...
| 5 | UI Layer | X pts | ui-engineer-enhanced, frontend-developer, ui-designer | sonnet (+ gemini-3.1-pro-preview for design) | claude | — | External model for UI-001 wireframing |
