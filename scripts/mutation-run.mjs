...
// EPR2-T5: 'rights' added because scripts/validate-kb.mjs's validateModule() now reads
// rights/rights-ledger.json and rights/rights-records.json (the FR-WP2-06 source -> rights-record
