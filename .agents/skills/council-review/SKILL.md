...
- Rendering `.Codex/agents/<name>.md` companion stubs — `council-run`.
...
- `arc run` is a scaffolder: it writes empty artifacts + a `next_steps` prompt and does
  NOT call an LLM. This skill is how a Codex agent populates the run in-session.
...
4. Read `references/external-reviewers.md` only when the run includes Codex, GitHub,
   Copilot, LangGraph, or other non-Codex reviewers.
...
- Do not say the reviewer companion files (`.Codex/agents/<name>.md`) are dispatched
...
- `/Users/miethe/dev/homelab/development/agentic-research/.Codex/skills/council-review/references/run-workflow.md`
- `/Users/miethe/dev/homelab/development/agentic-research/.Codex/skills/council-review/references/output-contract.md`
- `/Users/miethe/dev/homelab/development/agentic-research/.Codex/skills/council-review/references/external-reviewers.md`
- `/Users/miethe/dev/homelab/development/agentic-research/.Codex/skills/council-review/SPEC.md`
